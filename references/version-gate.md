...
layout itself breaks. Routine `v4.x.y` releases do not touch it.
...
|---|---|
| `design`, `plan`, `build`, `parallel-build`, `fix`, `spec`, `ship`, `to-issues`, `team` | **Hard-block** — run the full procedure; BLOCK halts the skill. |
